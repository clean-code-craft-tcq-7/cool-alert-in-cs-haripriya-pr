...
public static class CoolingAlert
{
    // ----------- STEP 2 -----------------
    // Minimal code to compile and fail the test in STEP 2 of test_cooling_alert
    private const float PASSIVE_COOLING_LIMIT = 40.0f;
    private const float HI_ACTIVE_COOLING_LIMIT = 55.0f;

    public static Action BatteryTemperatureToAction(CoolingType coolingType, float temperature)
    {
